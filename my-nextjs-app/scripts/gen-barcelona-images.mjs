...
const CURATED = [
  { folder: "1-sagrada-familia", name: "Sagrada Família",
    source: "unsplash", id: "KBELvmd67Fk" },
  { folder: "2-park-guell", name: "Park Güell",
    source: "unsplash", id: "1RD1h0Cnkng" },
  { folder: "3-casa-batllo", name: "Casa Batlló",
    source: "unsplash", id: "YXjTwszVYcw" },
  ...
  { folder: "5-picasso-museum", name: "Picasso Museum",
    source: "commons", file: "Museu Picasso Barcelona.JPG",
    query: "Museu Picasso Barcelona Carrer Montcada facade" },
  { folder: "6-gaudi-experience", name: "Gaudí Experience",
    source: "commons", query: "Antoni Gaudí Barcelona architecture",
    note: "No free photo of the Gaudí Experience attraction itself exists; a representative Gaudí image is used. Swap if you obtain a licensed photo of the venue." },
  { folder: "7-montjuic-castle-castell-de-montjuic", name: "Montjuïc Castle (Castell de Montjuïc)",
    source: "commons", file: "Montjuïc Castell.JPG",
    query: "Castell de Montjuïc Barcelona castle" },
  { folder: "8-hospital-de-sant-pau", name: "Hospital de Sant Pau",
    source: "commons", file: "Hospital de Sant Pau (new building at the north).JPG",
    query: "Hospital de Sant Pau Barcelona Domènech i Montaner" },
  { folder: "9-camp-nou-barca-stadium-tour", name: "Camp Nou (Barça Stadium Tour)",
    source: "unsplash", id: "b84nM5W-AF0" },
  { folder: "11-cosmocaixa", name: "CosmoCaixa",
    source: "commons", file: "CosmoCaixa Barcelona.JPG",
    query: "CosmoCaixa Barcelona science museum building" },
  ...
  { folder: "16-magic-fountain-font-magica", name: "Magic Fountain (Font Màgica)",
    source: "unsplash", id: "qMYUraYNqks" },
