...
export default function Navbar() {
  ...
  return (
    <nav className="grid grid-cols-[1fr_auto_1fr] items-center border-b border-black/[.08] bg-white/70 px-6 py-4 backdrop-blur-md dark:border-white/[.145] dark:bg-zinc-950/60">
      ...
      <button
        onClick={toggleTheme}
        className="justify-self-end rounded-full border border-black/[.08] px-3 py-1.5 text-sm font-medium transition-colors hover:bg-black/[.04] dark:border-white/[.145] dark:hover:bg-white/[.06]"
      >
