...
class CityConverter {
 ...
 static CONVERSION_RULES = {
    ...
    // ΚΑΝΟΝΑΣ 6: Για "0-2", "3-11", "12-17", "18+" (Ενυδρείο)
    "3-11": {
      "0-2": "0-2",
      "3-5": "3-11",
      "6-14": "12-17",
...
// ΚΑΝΟΝΑΣ 5: 0-5, 6-12, 13-17, 18+ (Miniatürk)
  ...
  console.log(`🔍 Εφαρμογή κανόνα "0-5" για: ${Object.keys(oldPrices)}`);
   ...
   // ΚΑΝΟΝΑΣ 6: Για "0-2", "3-11", "12-17", "18+" (Ενυδρείο)
else if (oldGroups.includes("0-2") && oldGroups.includes("3-11") && oldGroups.includes("12-17") && oldGroups.includes("18+")) {
  conversionRule = "3-11";
  console.log(`🔍 Εφαρμογή κανόνα "3-11" για: ${Object.keys(oldPrices)}`);
} 
